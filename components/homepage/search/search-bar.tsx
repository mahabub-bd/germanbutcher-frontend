    ...
    <div className="relative group">
      <div className="relative flex items-center">
        ...
        <Input
          ...
          className="lg:w-30 xl:w-80 2xl:w-100 pl-8 pr-8 py-1 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-primaryColor text-gray-900 placeholder-gray-500 transition-all duration-200 hover:border-gray-300"
          autoComplete="off"
          spellCheck="false"
        />
        {searchQuery && (
