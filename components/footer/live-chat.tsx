    ...
    return (
      <div className="fixed bottom-6 right-20 z-50">
        <button
          ...
          className="relative bg-primaryColor text-white rounded-full p-3 shadow-lg transition-all duration-300 hover:scale-105"
        >
          <MessageCircle className="w-5 h-5" />
          {unreadCount > 0 && (
            <span className="absolute -top-1 -right-1 bg-white text-green-500 border border-green-500 text-xs rounded-full w-5 h-5 flex items-center justify-center font-bold">
              {unreadCount}
            </span>
          )}
        </button>
              ...
              <div className="p-3 h-56 flex flex-col justify-center">
                ...
                <div className="space-y-2">
                  ...
                  <button
                    ...
                    className="w-full p-2 rounded-lg border border-gray-200 hover:border-green-500 transition-all duration-200 hover:bg-green-50 group"
                  >
                    <div className="flex items-center space-x-2">
                  ...
                  <button
                    ...
                    className="w-full p-2 rounded-lg border border-gray-200 hover:border-blue-500 transition-all duration-200 hover:bg-blue-50 group"
                  >
                    <div className="flex items-center space-x-2">
                ...
                <div className="space-y-2">
                  <div>
                    <input
                      ...
                      className="w-full px-2 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500"
                    />
                  </div>
                  <div>
                    <textarea
                      ...
                      className="w-full px-2 py-1 text-xs border rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 h-14 resize-none"
                    />
                  </div>
                    ...
                    <div className="flex flex-wrap gap-1">
                      {quickMessages.map((msg, index) => (
                        <button
                          ...
                          className="text-[10px] bg-gray-100 hover:bg-gray-200 text-gray-700 px-1.5 py-0.5 rounded"
                        >
                          {msg}
                        </button>
                      ))}
